export default {
      ...
      },
      {
        ...
        subMenu: [
          ...
          },
          {
            ...
            numero: '2.3',
            titulo:
              'Etiqueta y protocolo empresarial: concepto, reglas, imagen corporativa, normas de cortesía',
            hash: 't_2_3',
          },
        ],
      },
  ...
  referencias: [
    {
      referencia:
        'Abello, M. C., Abello, V., y Molina, H. (2016). Atención al cliente: Ciclo del servicio. [Gráfico].',
      link:
        'https://1.bp.blogspot.com/-4y0z4as4h-U/WAWYnuiQSUI/AAAAAAAAAJ0/biKAyFHT624wRCcbFQZsExtGqphyHFj7wCLcB/s1600/cooonc.png',
    },
    {
      referencia:
        'Albrecht, K. (1992). Triángulo del servicio [Esquema]. En La excelencia en el servicio. Legis Ltda.',
    },
    {
      referencia:
        'Albrecht, K., y Bradford, L. J. (1992). La excelencia en el servicio. Legis Ltda.',
    },
    {
      referencia:
        'Alcázar P. (2020). El cliente- relación empresa-cliente UT9.',
      link:
        'https://www.edebe.com/ciclosformativos/zona-publica/UT09_830030_LA_CEyAC_CAS.pdf',
    },
    {
      referencia:
        'Cámara de Comercio de Bogotá. (2010). Cartilla práctica. Etiqueta empresarial.',
      link:
    ...
    {
      referencia:
        'Martínez, M. (2013). Manual básico de protocolo empresarial y social. Díaz de Santos.',
    ...
    {
      referencia:
        'Organización Internacional de Normalización. (2015). Sistemas de gestión de la calidad (ISO 9001).',
      link: 'https://www.iso.org/obp/ui/#iso:std:iso:9001:ed-5:v1:es',
    },
    {
      referencia:
        'Pérez, O. (13 marzo de 2017). 5 reportes esenciales para mejorar el servicio a clientes.',
      link:
    ...
    {
      referencia:
        'Prieto, J. E. (2018). Gerencia del servicio: la clave para ganar todos. (4 ed.) [Libro electrónico]. ECOE Ediciones. ',
      link:
        'https://www.ecoeediciones.com/wp-content/uploads/2018/03/Gerencia-del-servicio-4ed.pdf',
    },
    {
    ...
    {
      referencia:
        'Villanueva, R. (2017). Comunicación y atención al cliente en hostelería y turismo. IC Editorial. ',
      link: 'http://www.ebooks7-24.com.bdigital.sena.edu.co/?il=8742',
    },
    {
      referencia:
        'WTS. (16 julio de 2019). El tiempo de respuesta al cliente, vital en una venta. Way to Success. ',
      link:
  ...
  complementario: [
    ...
    {
      texto:
        'Política de Atención al Cliente - Pymerang.	Ugalde, R., A., (16 de septiembre de 2019) Política de Atención al Cliente. Pymerang.com',
      tipo: 'Página web',
      link:
    ...
    {
      texto:
        'Métricas e indicadores para la gestión de servicios ITL.	Fernández, P., J. L. (14 de septiembre de 2019). Midiendo ITIL, métricas e indicadores para la gestión de servicios ITL. Proactivanet.com',
      tipo: 'Página web',
